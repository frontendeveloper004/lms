...
import EnglishModuleQuizzesPage from "./EnglishQuizzesClient";
import ModuleQuizzesPage from "./ProgrammingQuizzesClient";
...
export default function QuizRouterPage() {
  ...
  if (subjectType === "ENGLISH") {
    return <EnglishModuleQuizzesPage />;
  }

  return <ModuleQuizzesPage />;
}
